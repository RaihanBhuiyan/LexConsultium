              ...
              <div className="row">
                ...
                <div className="col-lg-7">
                  <div className="about-area__content">
                    ...
                    <p className=".cr-section.about-area">LexConsultium, is one of the leading law chamber in Bangladesh. It provides a
                      comprehensive range of legal services for both national and international clients.LexConsultium is comprised of a group of young energetic & talented lawyers who
                      dedicate considerable energy, talent, expert and resources to meaningful causes and
                      initiatives that reflects our values and vision. The team of LexConsultium ensures highly
                      professional and positive legal assistance and advice in quick time with efficiency,
                      effectiveness, cost effective and success, which also define the characteristics of the firm.
                      Whether you need any legal assistance in any matters on an aspect of a deal or a step by
                      step approach from conception to fruition, our expert team or lawyers will give you
                      necessary guide through each stage of the process or problems. For us, it’s about offering
                      long-term, successful solutions and professional guidance in a sustainable, meaningful way.</p>
